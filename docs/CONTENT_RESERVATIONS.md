...
| Durum | Fiiller |
| --- | --- |
| Utku'ya ayrıldı (Q27) | DÖKMEK (kullanıldı: `q-018`), BASMAK (kullanıldı: `q-019`), SÜRMEK (kullanıldı: `q-021`, deyim anlamı), GEÇMEK (kullanıldı: `q-022`), VURMAK, ÇALMAK (kullanıldı: `q-020`), SİLMEK |
