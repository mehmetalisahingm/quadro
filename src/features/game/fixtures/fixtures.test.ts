...
import prototip1012 from "@/content/puzzles/2026-10-12.json";
import {
  GAME_CONSTANTS,
  normalizeTr,
  slugifyTr,
...
describe("örnek bulmacalar", () => {
  ...
  it("örnekler günlük bulmacaların kelimelerini kullanmaz (cevap ifşası yok)", () => {
    const dailyTexts = new Set(
      [prototip20, prototip21, prototip22, prototip23, prototip24, prototip1007, prototip1008, prototip1009, prototip1010, prototip1011, prototip1012].flatMap((puzzle) =>
